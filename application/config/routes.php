...
$route['product/(:any)'] = 'frontpage/product_$1';
$route['order/place'] = 'order/place_order';
$route['catering'] = 'frontpage/display_catering';
$route['ready-to-eat'] = 'frontpage/display_ready_to_eat';
$route['points'] = 'frontpage/selling_point';
$route['profile'] = 'frontpage/my_account_page';
