  ...
  <section class="boxku">
		<div class="row">
        	...
        	<div class="box-body no-padding">
						<!-- form start -->
						<form role="form" id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url().($title=="add" ? 'cms/add_post' : 'cms/update_post?id='.$this->input->get('id'));?>">
											...
											<?php 
												if($category<>false){ 
													foreach($category->result() as $row){
														if($title=="edit") $category_array = explode(',', $post_data->category);
											?>
